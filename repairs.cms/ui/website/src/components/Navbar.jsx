            ...
            <NavigationMenu className="rounded-full border border-border/40 bg-background/60 backdrop-blur-xl shadow-sm">
                <NavigationMenuList className="px-2 py-1">
                    <NavigationMenuItem>
                        <NavLink
                            to="/"
                            className={cn(navigationMenuTriggerStyle(), "uppercase font-bold bg-transparent hover:bg-accent/50 data-[active]:bg-accent/50 rounded-full")}
                        >
                            {websiteData?.appname ?? <img src={websiteData?.applogo} alt="" />}
                        </NavLink>
